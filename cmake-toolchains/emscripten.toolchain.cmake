...
option(FIPS_EMSCRIPTEN_USE_WASI "enable WASI output" OFF)
...
if (FIPS_EMSCRIPTEN_USE_WASI) 
    set(FIPS_EMSCRIPTEN_POSTFIX ".wasm" CACHE STRING "emscripten output postfix")
else()
...
if (FIPS_EMSCRIPTEN_USE_WASI)
    set(EMSC_LINKER_FLAGS "${EMSC_LINKER_FLAGS} -s STANDALONE_WASM")
endif()
