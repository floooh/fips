...
macro(fips_setup_link_directories)
    ...
    # of all projects
    # link_directories(${FIPS_ROOT_DIR}/lib/${FIPS_PLATFORM_NAME})
endmacro()
...
macro(fips_config_postfixes_for_exe target)
    if (NOT FIPS_ANDROID)
        if (FIPS_EMSCRIPTEN)
            ...
            set_target_properties(${target} PROPERTIES PROFILING_POSTFIX _profiling.html)
        elseif (FIPS_PNACL)
            ...
            set_target_properties(${target} PROPERTIES PROFILING_POSTFIX _profiling.pexe)
        else()
            set_target_properties(${target} PROPERTIES DEBUG_POSTFIX _debug)
            set_target_properties(${target} PROPERTIES PROFILING_POSTFIX _profiling)
        endif()
    endif()
...
function(fips_exe_output_directory target)
    if (NOT (FIPS_IOS OR FIPS_ANDROID))
        set(dir ${FIPS_PROJECT_DIR}/bin/${FIPS_PLATFORM_NAME})
