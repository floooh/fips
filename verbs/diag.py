...
from mod.tools import make, ninja, xcodebuild, xcrun, java, javac, node, ccache, sccache
...
def check_tools(fips_dir) :
    ...
    tools = [ git, cmake, ccmake, cmake_gui, make, ninja, xcodebuild, xcrun, javac, java, node, python2, ccache, sccache, vscode, clion, httpserver ]
