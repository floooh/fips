...
from mod.tools import make, ninja, xcodebuild, xcrun, java, javac, node, ccache, wasmtime
...
def check_tools(fips_dir) :
    ...
    tools = [ git, cmake, ccmake, cmake_gui, make, ninja, xcodebuild, xcrun, javac, java, node, python2, ccache, vscode, clion, httpserver, wasmtime ]
