...
from mod.tools import git, cmake, ccmake, cmake_gui, vscode, vscode_cpptools, vscode_cmaketools, vscode_codelldb, clion
...
def check_tools(fips_dir) :
    ...
    tools = [ git, cmake, ccmake, cmake_gui, make, ninja, xcrun, javac, java, node, vscode, vscode_cpptools, vscode_cmaketools, vscode_codelldb, clion, httpserver, wasmtime ]
