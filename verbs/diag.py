...
from mod.tools import make, ninja, xcodebuild, ant, java, node, ccache
...
def check_tools(fips_dir) :
    ...
    tools = [ git, cmake, ccmake, cmake_gui, make, ninja, xcodebuild, java, ant, node, python2, ccache, vscode ]
